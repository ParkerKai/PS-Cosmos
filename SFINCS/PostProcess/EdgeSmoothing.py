    ...
    for slr in SLRs:
        ...
        for index_cat, category in enumerate(sub_categories):
            ...
            for rp in RPs:
                ...
                tiff_wanted         = join(destout, f'depth_{rp:03}{res_name}.tif')
                tiff_out            = join(destout, f'connection_{rp:03}{res_name}.tif') 
                ...
                with rasterio.open(tiff_wanted) as src:
                    ...
                    for var_name in variables_wanted:
                        ...
                        # Define names
                        input_filename  = join(destout, f'{var_name}_{rp:03}{res_name}.tif')
                        output_filename = join(destout, f'{var_name}_{rp:03}{res_name}_masked.tif')
