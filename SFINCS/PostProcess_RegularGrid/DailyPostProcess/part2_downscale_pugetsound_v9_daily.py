...
for index, county in enumerate(counties):
    ...
    for slr in SLRs:
        ...
        for index_cat, category in enumerate(sub_categories):
            ...
            fnc                     = join(destin, 'processed_SFINCS_output_RPdaily.nc')
            floodmap_fn             = join(destout, f'depth_daily{res_name}.tif')
            ...
            for var_name in variables_wanted:
                ...
                # Do actual writing
                output_filename = join(destout, f'{var_name}_daily{res_name}.tif')
