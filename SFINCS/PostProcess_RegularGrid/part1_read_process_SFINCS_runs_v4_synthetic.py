...
for domain in domains:
    ...
    for index, slr in enumerate(SLRs_formatted):
        ...
        for index_cat, category in enumerate(sub_categories):
            ...
            for file in files:
                if file.startswith(string_wanted):
                    ...
                    if read_binary == 1:
                        ...
                        sfincs_vmax     = os.path.join(destin_TMP, file, 'velmax.dat')
            ...
            print(f'Shape of zsmax_matrix is: {Ns},{nx},{ny}')
            ...
            for i in range(zsmax_matrix.shape[1]):
                for j in range(zsmax_matrix.shape[2]):
                    ...
                    if num_non_nans > 0:
                        ...
                        years_out[:,i,j] = sim_list[ascending_indices[nearest_indices]]
