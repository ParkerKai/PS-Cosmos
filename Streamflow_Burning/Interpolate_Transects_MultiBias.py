...
fig_out         = r'C:\Users\kaparker\Documents\Weekly_Updates\11_08_2023\figure'
name = 'Puyallup'
...
#===============================================================================
if name == 'Puyallup':
    file_in1 = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\PierceKing\20230817_historical_USGS_gauges_full_period_thalweg_analysis\02_Pierce\bias_correcton.shp'
    file_in2 = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\PierceKing\20231003_historical_USGS_gauges_full_period_thalweg_analysis\02_Pierce\bias_correcton.shp'
    file_in3 = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\PierceKing\20231019_historical_USGS_gauges_full_period_thalweg_analysis\02_Pierce\bias_correcton.shp'
    
elif  name == 'Duwamish':
    file_in1 = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\PierceKing\20230817_historical_USGS_gauges_full_period_thalweg_analysis\01_King\bias_correcton.shp'
    file_in2 = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\PierceKing\20231003_historical_USGS_gauges_full_period_thalweg_analysis\01_King\bias_correcton.shp'
    file_in3 = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\PierceKing\20231019_historical_USGS_gauges_full_period_thalweg_analysis\01_King\bias_correcton.shp'

Bias1 = gpd.read_file(file_in1)
Bias2 = gpd.read_file(file_in2)
Bias3 = gpd.read_file(file_in3)
Bias3 = Bias3.set_crs('epsg:6318')
...
thalweg_z['bias_interp']  = thalweg_z['bias1_interp'] + thalweg_z['bias2_interp']+ thalweg_z['bias3_interp']
...
if name == 'Puyallup':
    ...
    thalweg_z['bias_interp'].iloc[353:None] = np.linspace(thalweg_z['bias_interp'].iloc[353], 0, num=thalweg_z.shape[0]-353)
...
spl.set_smoothing_factor(s=150)
...
ax.plot(thalweg_dist,thalweg_z['Survey_interp'],'.', color = 'red',label = 'Survey')
...
trns_z_out.to_file(os.path.join(dir_raster_out,name,'NewBathy4_{}.shp'.format(name)))
...
# Save the file
polygon_edit.to_file(os.path.join(dir_gis,name,'{}_EditPolygon4.shp'.format(name)))
