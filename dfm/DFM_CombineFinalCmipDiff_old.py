...
year_list  = np.arange(2011,2025,1)
...
def main():    
    ...
    for year in year_list:
        ...
        files = os.path.join(dir_in_era5,'Results_Combined',f'ERA5_cdf_{year}.nc')
        ...
        files = [os.path.join(dir_in_diff,f'ERA5wl_Diff_{year}_{month:02d}.nc')
