...
dir_out = r'C:\Users\kaparker\Documents\Projects\PS_Cosmos\figures\CDF_Diff\Waves\Shapefiles'
...
for SLR in SLR_list:
    ...
    out.to_file(os.path.join(dir_out,f'Wave_Hs_ERA5Stats_{SLR}.shp'))
