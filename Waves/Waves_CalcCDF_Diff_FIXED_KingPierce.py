...
for county in county_list:
    ...
    file_in = os.path.join(
        ...
        f"LUT_output_{county}_CMCC_his.mat",
    )
    ...
    for SLR in SLR_list:
            ...
            for month in np.arange(1, 13, 1, dtype=int):
                ...
                with open(
                    os.path.join(
                        ...
                        Mod,
                        f"CDFmonthly_{month:02d}_{Mod:s}.pkl",
                    ),
                    "rb",
                ) as f:
                ...
                with open(
                    os.path.join(
                        ...
                        Mod,
                        f"CDFmonthly_{month:02d}_{Mod:s}_SLR{SLR:s}.pkl",
                    ),
                    "rb",
                ) as f:
        ...
        dir_out_sub = os.path.join(dir_out, f"LUT_{county}_CMIP6_Diff", SLR)
