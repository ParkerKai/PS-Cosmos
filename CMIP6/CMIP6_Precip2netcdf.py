...
dir_out = r'Y:\PS_Cosmos\CMIP6\Precipitation';
...
data_vars = {'pr':(['time','lat','lon'], Var_extract, 
                         ds2.attrs)}
...
ds_out.to_netcdf(os.path.join(dir_out,ver,
                              'psfm_{}_{}_precip.nc'.format(mod_short,ver)),
                 encoding={'pr': {'dtype': 'float32', '_FillValue': -9999},
